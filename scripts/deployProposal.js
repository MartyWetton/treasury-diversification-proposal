...
async function main() {
  ...
  await deploy({ ...contracts.proposalContract, singletonFactory })
  console.log(
    `TreasuryDiversificationProposal have been deployed on ${contracts.proposalContract.address} address`,
  )
}
